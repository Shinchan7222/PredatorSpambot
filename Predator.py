...
from Config import STRING, SUDO, BIO_MESSAGE, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, SUDO_HANDLER
import asyncio
...
async def start_predator():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@HellBot_Chat"))
...
loop.run_until_complete(start_predator())       
...
async def spam(e):
    ...
    error = "Aukat se bhar mat jao bhiya🙂❤️."
    if e.sender_id in SMEX_USERS:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        predator = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        predatorsexy = predator[1:]
        if len(predatorsexy) == 2:
            message = str(predatorsexy[1])
            counter = int(predatorsexy[0])
            sleeptime = float(predator[0])
            for _ in range(counter):
...
print(text)
print("")
print("SMEX! Predator Multi Spam Bot Started Sucessfully.")
